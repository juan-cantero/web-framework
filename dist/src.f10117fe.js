...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/models/Component.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Component(state, events, sync) {
    this.state = state;
    this.events = events;
    this.sync = sync;
  }

  Object.defineProperty(Component.prototype, "on", {
    get: function get() {
  ...
  Object.defineProperty(Component.prototype, "trigger", {
    get: function get() {
  ...
  Object.defineProperty(Component.prototype, "get", {
    get: function get() {
  ...
  Component.prototype.set = function (update) {
  ...
  Component.prototype.save = function () {
    ...
    this.sync.save(state).then(function (response) {
...
},{}],"src/models/State.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  State.prototype.set = function (update) {
...
function () {
  ...
  Object.defineProperty(Collection.prototype, "triggrer", {
    get: function get() {
      return this.events.trigger;
    },
    enumerable: false,
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.items.push(_this.deserialize(value));
      });
    });
  };
...
function (_super) {
  ...
  User.buildUser = function (props) {
    return new User(new State_1.State(props), new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl));
  };
...
exports.User = User;
},{"./Component":"src/models/Component.ts","./State":"src/models/State.ts","./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Collection":"src/models/Collection.ts"}],"src/views/ComponentUi.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function ComponentUi(parent, component) {
    this.parent = parent;
  ...
  ComponentUi.prototype.bindComponent = function () {
    var _this = this;
  ...
  ComponentUi.prototype.eventsMap = function () {
    return {};
  };

  ComponentUi.prototype.regionMap = function () {
    return {};
  };

  ComponentUi.prototype.mapRegions = function (fragment) {
  ...
  ComponentUi.prototype.bindEvents = function (fragment) {
    var eventsToBind = this.eventsMap();
    ...
    for (var eventKey in eventsToBind) {
      _loop_1(eventKey);
    }
  };

  ComponentUi.prototype.onRender = function () {};

  ComponentUi.prototype.render = function () {
    this.parent.innerHTML = '';
    var templeElement = document.createElement('template');
...
var ComponentUi_1 = require("./ComponentUi");
...
function (_super) {
  ...
  return UserShow;
}(ComponentUi_1.ComponentUi);

exports.UserShow = UserShow;
},{"./ComponentUi":"src/views/ComponentUi.ts"}],"src/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
var ComponentUi_1 = require("./ComponentUi"); // The content of an template is a DocumentFragment.
...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.onSaveClick = function () {
      _this.component.save();
    };

    _this.onSetAgeClick = function () {
      _this.component.setRandomAge();
    };
...
},{"./ComponentUi":"src/views/ComponentUi.ts"}],"src/views/UserEdit.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  UserEdit.prototype.onRender = function () {
    new UserShow_1.UserShow(this.regions.userShow, this.component).render();
    new UserForm_1.UserForm(this.regions.userForm, this.component).render();
  };
...
},{"./ComponentUi":"src/views/ComponentUi.ts","./UserShow":"src/views/UserShow.ts","./UserForm":"src/views/UserForm.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var userEdit = new UserEdit_1.UserEdit(document.getElementById('root'), User_1.User.buildUser({
  name: 'juan',
  age: 18
}));
userEdit.render();
